...
export function validateSubscription(input) {
  ...
  if (!isValidName(input.first_name)) {
    validationErrors.first_name =
      'Invalid First Name. Must be at most 20 characters long.';
  }
  if (!isValidName(input.last_name)) {
    validationErrors.last_name =
      'Invalid Last Name. Must be at most 20 characters long.';
  }
  if (!isValidName(input.company)) {
    validationErrors.company =
      'Invalid Company. Must be at most 20 characters long.';
  }
  if (Object.keys(validationErrors).length > 0) {
    throw validationErrors;
  }
